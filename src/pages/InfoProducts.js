...
import textProduct1 from '../imagesProduct/adChange1.svg' // адаптив

import textProduct2 from '../imagesProduct/adChange2.svg'

import textExport from '../imagesProduct/adChange3.svg'
import iconExport from '../imagesProduct/Iconexport.svg'

import textEvent from '../imagesProduct/adChange4.svg'
...
import blocksAll1 from '../imagesProduct/changessss1.svg'
import blackAll2 from '../imagesProduct/channngee2.svg'
import blockAll3 from '../imagesProduct/changee3.svg'
import blockAll5 from '../imagesProduct/changee4.svg'
...
export let RusBusness = [
    ...
    },
    {
        ...
        text: " Вы ищете возможности для развития компании? Хотите новые решения? Мы предлагаем вам мастер классы, семинары, тренинги и курсы на темы бизнес управления, финансирования, экспорта и энерго-эффективности.",
        br: 'Нажмите кнопку внизу для получения подробной информации.'
    ...
    },
    {
        id: 3,
        icon: bis3,
        title: 'Сообщество  Предпринимателей',
    ...
    },
    {
        ...
        icon: bis4,
        title: 'Бизнес Лагеря',
        text: "Возраст от 18 до 30 лет — это период, полный энтузиазма, чтобы что-то сделать. Bootcamp — это одна из лучших возможностей не только для семинаров и направлений, но и для ежедневного общения с целеустремленными людьми. По итогам бизнес-лагерей потенциальные предприниматели учатся как начать свой бизнес, как делать маркетинг и оценивать свои ресурсы.",
        br: 'Нажмите кнопку внизу для получения подробной информации.'
    }
]
...
export let RusFinans = [
    {
        id: 1,
        icon: fin1,
        title: 'База Данных для поиска финансов',
    ...
    },
    {
        ...
        text: "Хотите научиться планировать свои доходы и расходы? Не знаете как составлять план для достижения финансовой цели? Нужна информация про финансовые продукты? Хотите узнать как распознать мошенников и противостоять им? Хотите научиться копить и увеличивать свои деньги? Но не знаете как?",
        br: ' Нажмите кнопку внизу для получения подробной информации.'
...
export let RusExport = [
    ...
    },
    {
        ...
        text: 'Понимаете что пора экспортировать свой товар, но не знаете с чего начать и по какому порядку идти? Не знаете как подготовить свою компанию к новому этапу развития? Приходите к нам и наши консультанты вам помогут с решением этих вопросов.',
        br: ' Нажмите кнопку внизу для получения подробной информации'
    },
    {
        id: 5,
        ...
        text: "Для экспорта нужно слишком документов? Запутались как и когда они нужны? Ищете нужного юриста, но не можете найти? Слишком много требований от обоих (или же нескольких) государств? Наша компания предлагает вам юридическое сопровождение при экспорте.",
        br: ' Нажмите кнопку внизу для получения подробной информации.'
